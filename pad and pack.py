...
print('flatten(seqs): ', flatten(seqs))
...
seq_lengths = torch.LongTensor([len(item) for item in vectorized_seqs])
print ('seq_lengths: ', seq_lengths)

# dump padding everywhere, and place seqs on the left.
# NOTE: you only need a tensor as big as your longest sequence
seq_tensor = Variable(torch.zeros((len(vectorized_seqs), seq_lengths.max()))).long()
print ('zeros tensor: ', seq_tensor)

print ('zip: ', zip(vectorized_seqs, seq_lengths))
...
# print ('embeded matrix: ', seq_tensor)
print ('embedding size: ', seq_tensor.size())
